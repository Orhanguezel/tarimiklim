      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div className="space-y-2">
          <div className="flex items-center gap-3">
            ...
            <span className="text-gm-gold font-bold text-[10px] tracking-[0.2em] uppercase">Pazarlama</span>
          </div>
          <h1 className="font-serif text-4xl text-gm-text">Campaigns & Promos</h1>
          <p className="text-gm-muted text-sm font-serif italic max-w-xl">
            Manage discount codes, bonus credits, and special offers.
          </p>
        </div>

          ...
          <div className="flex gap-4 items-center">
            {hasSelection && (
              <Button
                ...
                disabled={busy}
                className="rounded-full bg-red-500/10 text-red-500 hover:bg-red-500 hover:text-white transition-all font-bold tracking-widest uppercase text-[10px] px-8 h-12 border-0"
              >

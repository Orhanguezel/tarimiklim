  ...
  return (
    <div className="space-y-8 pb-12 animate-in fade-in duration-700">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div className="space-y-2">
          <div className="flex items-center gap-3">
            ...
            <span className="text-gm-gold font-bold text-[10px] tracking-[0.2em] uppercase">Analitik</span>
          </div>
          <h1 className="font-serif text-4xl text-gm-text">{t('reports.title', {}, 'Raporlar (Admin)')}</h1>
        ...
        <div className="flex flex-wrap gap-2 items-center">
          <Button
            ...
            className="rounded-full border-gm-border-soft bg-gm-surface/20 hover:bg-gm-surface hover:text-gm-gold font-bold tracking-widest uppercase text-[9px] px-6 h-10"
          >
          ...
          <Button
            ...
            className="rounded-full bg-gm-gold text-gm-bg hover:bg-gm-gold/90 transition-all font-bold tracking-widest uppercase text-[9px] px-6 h-10 border-0"
          >
            {busy ? (
      ...
      <Card className="bg-gm-surface/20 border-gm-border-soft rounded-[32px] overflow-hidden backdrop-blur-sm shadow-xl">
        <CardHeader className="border-b border-gm-border-soft/50 pb-6 p-8 gap-2">
          <CardTitle className="font-serif text-2xl text-gm-text">{t('reports.tabs.title', {}, 'Sekmeler')}</CardTitle>

    ...
    <div className="space-y-8 pb-12 animate-in fade-in duration-700">
      ...
      <Card className="bg-gm-surface/20 border-gm-border-soft rounded-[32px] overflow-hidden backdrop-blur-sm shadow-xl">
        <CardHeader className="border-b border-gm-border-soft/50 pb-6 p-8">
          <CardTitle className="font-serif text-2xl text-gm-text">{t('wallets.title', {}, 'Cüzdanlar')}</CardTitle>
      ...
      <Card className="bg-gm-surface/20 border-gm-border-soft rounded-[32px] overflow-hidden backdrop-blur-sm shadow-xl">
        <CardHeader className="border-b border-gm-border-soft/50 pb-6 p-8">
          <CardTitle className="font-serif text-2xl text-gm-text">{t('deposits.title', {}, 'Yatırım Talepleri')}</CardTitle>
          <CardDescription className="text-gm-muted font-serif italic mt-2">

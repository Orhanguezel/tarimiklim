...
export function buildTelegramPreviewVars(defaultLocaleCode: string): TelegramTemplateVars {
  return {
    ...
    company_name: 'Akdeniz Uretim Ciftligi',
    message: 'Gece don riski icin erken uyari istiyorum.',
    created_at: '2026-03-20 18:30:00',
    product_service: 'Frost risk alert',
    subject: 'Don uyarisi bilgilendirme talebi',
    name: 'Mehmet Demir',
    ...
    priority: 'high',
    category: 'Don Uyarisi',
    locale: defaultLocaleCode,
    location_name: 'Antalya Merkez',
    alert_type: 'frost',
    channel: 'telegram',
    threshold: '2',
    ...
    rain_mm: '22',
    severity: 'warning',
    updated_at: '2026-03-20 19:05:00',

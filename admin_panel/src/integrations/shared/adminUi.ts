...
export function normalizeAdminUiCopy(raw: unknown): AdminUiCopy {
  ...
  const labels: AdminNavCopy['labels'] = {
    ...
    tarimiklim: uiText(labelsRaw.tarimiklim),
  };
  ...
  const items: AdminNavCopy['items'] = {
    ...
    tarimiklim_hub: uiText(itemsRaw.tarimiklim_hub),
    tarimiklim_locations: uiText(itemsRaw.tarimiklim_locations),
    tarimiklim_alerts: uiText(itemsRaw.tarimiklim_alerts),
    tarimiklim_alert_rules: uiText(itemsRaw.tarimiklim_alert_rules),
    tarimiklim_alert_subscriptions: uiText(itemsRaw.tarimiklim_alert_subscriptions),
  };

...
const adminLoginQuote =
  (process.env.NEXT_PUBLIC_ADMIN_LOGIN_QUOTE || '').trim() ||
...
export const DEFAULT_BRANDING: AdminBrandingConfig = {
  ...
  admin_login_heading: (process.env.NEXT_PUBLIC_ADMIN_LOGIN_HEADING || '').trim(),
  admin_login_quote: adminLoginQuote,

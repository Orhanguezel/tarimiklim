...
export async function generateMetadata({
  ...
  if (!province) return {};
  return buildCityMetadata('hava-durumu', locale, province);
}

export default async function HavaDurumuCityPage({
  params,
}: {
  params: Promise<{ locale: string; il: string }>;
}) {
  ...
  return (
    <section className="panel-shell">
      <CityWeatherView variant="hava-durumu" locale={locale} province={province} />
    </section>
  );
}

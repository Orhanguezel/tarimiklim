...
export async function generateMetadata(): Promise<Metadata> {
  const baseMeta: Metadata = {
    title: 'Bereket Fide Hava Widget | Tarim Iklim',
    description: 'Bereket Fide web siteleri icin gomulebilir hava durumu ve don riski widgeti.',
    robots: { index: false, follow: false },
  };
  const seo = await fetchPageSeo('widget-bereketfide', 'tr');
  return mergePageMetadata(baseMeta, seo, 'tr', '/widget/bereketfide');
}
